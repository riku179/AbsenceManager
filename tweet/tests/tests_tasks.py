...
class TestUpdateAttendance(TestCase):
    ...
    def attend_mondey(self):
        sub1 = Subject(user=self.test_user, period=1, day='Mon', name='spam')
        sub2 = Subject(user=self.test_user, period=2, day='Mon', name='egg')
        sub3 = Subject(user=self.test_user, period=4, day='Mon', name='spam egg')
        sub4 = Subject(user=self.test_user, period=6, day='Mon', name='spam spam egg')
        sub5 = Subject(user=self.test_user, period=2, day='Tue', name='spam spam egg spam')
        sub6 = Subject(user=self.test_user, period=3, day='Tue', name='egg spam spam egg spam')
        sub7 = Subject(user=self.test_user, period=4, day='Thu', name='egg spam egg spam spam spam')
        sub8 = Subject(user=self.test_user, period=1, day='Fri', name='egg egg spam egg spam spam spam')
        sub9 = Subject(user=self.test_user, period=5, day='Fri', name='spam egg egg spam egg spam spam spam')
